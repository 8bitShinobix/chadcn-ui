...
export function CopilotSidebar() {
  ...
  return (
    <div className="flex h-[550px] w-full overflow-hidden rounded-lg border md:h-[700px]">
      {/* Main content area */}
      ...
      {sidebarOpen && (
        <div className="fixed inset-y-0 right-0 z-50 flex w-full shrink-0 flex-col border-l bg-background transition-transform duration-300 md:static md:z-auto md:w-[380px] md:transition-none">
          {/* Header */}
