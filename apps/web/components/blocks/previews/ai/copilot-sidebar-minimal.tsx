...
export default function CopilotSidebarMinimal() {
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-3rem)] min-h-[500px] w-full max-w-4xl flex-col overflow-hidden sm:flex-row">
      ...
      {sidebarOpen && (
        <div className="flex max-h-[50%] min-h-0 w-full flex-col overflow-hidden border-t bg-background sm:max-h-none sm:w-[340px] sm:shrink-0 sm:border-l sm:border-t-0">
