...
export default function CopilotSidebarFeatureRich() {
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-3rem)] min-h-[500px] w-full max-w-5xl flex-col overflow-hidden sm:flex-row">
      {/* Main content area */}
      ...
      {sidebarOpen && (
        <div className="flex max-h-[50%] min-h-0 w-full flex-col overflow-hidden border-t bg-background sm:max-h-none sm:w-[380px] sm:shrink-0 sm:border-l sm:border-t-0">
          {/* Header */}
