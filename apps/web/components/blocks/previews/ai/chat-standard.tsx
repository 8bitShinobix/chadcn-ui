...
export default function ChatStandard() {
  const [messages, setMessages] = useState<Message[]>([
    { id: "1", role: "assistant", content: "Hello! I'm your AI assistant. Ask me anything and I'll do my best to help.", timestamp: new Date() },
  ])
    ...
    <div className="mx-auto flex h-[600px] w-full max-w-2xl flex-col rounded-lg border">
      ...
      <div className="p-4">
        <form onSubmit={(e) => { e.preventDefault(); handleSend() }} className="flex gap-2">
          <Input value={input} onChange={(e) => setInput(e.target.value)} placeholder="Type a message..." className="flex-1" disabled={isGenerating} />
          ...
          <Button type="button" size="icon" variant="outline" disabled={isGenerating || messages.length < 2} onClick={() => {
            ...
            setIsGenerating(true)
            simulateStreaming(newId, "Here's a regenerated response with different content.")
