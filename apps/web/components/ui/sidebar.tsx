  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-14 bottom-0 z-10 hidden w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear lg:flex",
          side === "left"
      ...
      >
        <div
          ...
          className="bg-background group-data-[variant=floating]:border-sidebar-border no-scrollbar flex h-full w-full flex-col overflow-y-auto group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
